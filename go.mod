module github.com/iainlane/octoflux

go 1.19

require (
	github.com/danopstech/octopusenergy v0.0.2-0.20210520083203-bfe47de87fa6
...
require (
	...
	github.com/quasilyte/go-ruleguard v0.3.9 // indirect
